...
from biometric_app.models import Detected,Employee,unreg,Checking, Checking_One, Checking_Two, Checking_Three
from biometric_app.models import Checking_Four, Checking_Five
