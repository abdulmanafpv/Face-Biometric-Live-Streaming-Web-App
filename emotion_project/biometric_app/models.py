...
class Employee(models.Model):
	...
	photo = models.ImageField(upload_to='biometric_app/pictures/', blank=True, null=True)
...
class unreg(models.Model):
	# photo = models.ImageField(upload_to='media/biometric_app/pictures',blank=True, null=True)
	photo = models.ImageField(upload_to='biometric_app/image',blank=True, null=True)
